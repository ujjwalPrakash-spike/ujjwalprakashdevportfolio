...
const steps = [
  {
    ...
    description:
      "Before laying down code, we map out clear operational deliverables. I translate business requirements into concrete system designs, mapping PostgreSQL database relationships, defining exact API interfaces, and identifying performance-critical paths.",
  ...
  },
  {
    ...
    description:
      "Building backends that load in sub-200ms under high load. I write type-safe APIs using Go (Gin) or Node.js (NestJS) coupled with PostgreSQL, incorporating optimal DB indexing, caching layers (Redis), and connection pooling to ensure data integrity.",
  ...
  },
  {
    ...
    description:
      "Preventing race conditions and bottlenecks. Drawing from experience managing IIT Kanpur's placement system for 20K+ users, I engineer lock-free buffers, background workers, and real-time operations engines.",
  ...
  },
  {
    ...
    description:
      "Delivering stable production environments. All projects are packaged neatly with Docker & Docker-Compose and deployed behind Nginx reverse proxies, with complete GitHub Actions CI/CD pipelines ensuring automated testing and deployment validation.",
...
const reviews = [
  {
    quote:
      "Ujjwal puts in the work. He delivered a complex system ahead of schedule that our team uses daily. Would hire again in a heartbeat.",
  ...
  {
    quote:
      "I like how Ujjwal teaches, he puts in the work required. His bootcamp sessions were the most practical engineering classes I've attended at IITK.",
  ...
  {
    quote:
      "Maintaining 37K+ LOC codebase for 20,000+ active users with 99.9% uptime. PIMS was built ahead of schedule with 2K+ daily active users from day one.",
      ...
      <div className="w-[87vw] mx-auto">
        ...
        <div className="max-w-[700px] mb-20">
          ...
          <p className="mt-6 text-[15px] md:text-[17px] leading-[1.7] text-[#2E3129] opacity-80">
            A systematic engineering pipeline designed to deliver
            production-grade software — and what clients & students say about
            working with Ujjwal.
          </p>
        </div>
        ...
        {/* ── Reviews ── */}
        <div className="mb-10">
          <h2 className="text-[clamp(1.6rem,3vw,2.8rem)] font-bold tracking-[-0.04em] leading-[0.95] text-[#2E3129] mb-12">
            What People Say
          </h2>
        ...
        >
          <div>
            ...
            <p className="text-neutral-400 mt-2 text-sm md:text-base max-w-[500px]">
              Hire a full-stack engineer with proven experience managing
              production applications. Book a meet or send a direct email.
            </p>
          </div>
          <a
            href="mailto:ujjwalprakash858@gmail.com"
